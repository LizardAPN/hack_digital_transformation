...
def merge_tables_with_tolerance(target,
    ...
    df1 = target.rename(columns={target.columns[0]: "filename", target_lat_name: "lat_target", target_lot_name: "lon_target"})
    df2 = real_data.rename(columns={real_data.columns[0]: "camera_id", real_data_lat_name: "lat_real", real_data_lot_name: "lon_real"})
