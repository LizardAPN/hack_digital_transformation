...
class Geocoder:
    ...
    def geocode(self, lat: float, lon: float) -> Optional[str]:
        ...
        geocoders = [self._yandex_geocode, self._google_geocode, self._openstreetmap_geocode]
    ...
    def _google_geocode(self, lat: float, lon: float) -> Optional[str]:
        ...
        try:
            ...
            params = {"latlng": f"{lat},{lon}", "key": self.google_api_key, "language": "ru"}
    ...
    def _openstreetmap_geocode(self, lat: float, lon: float) -> Optional[str]:
        ...
        try:
            ...
            params = {"lat": lat, "lon": lon, "format": "json", "addressdetails": 1, "accept-language": "ru"}

            headers = {"User-Agent": "BuildingDetector/1.0 (hackathon project)"}
